      ...
      <Container>
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 relative z-10 py-20">
          <div className="relative w-full max-w-2xl mx-auto flex flex-col items-center justify-center">
            ...
            <h1 className="text-[150px] md:text-[250px] font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-gray-700/50 via-[#199C16]/20 to-gray-900/50 absolute select-none z-0 tracking-tighter mix-blend-overlay">
              404
            </h1>
            
            {/* Foreground content */}
            <div className="z-10 flex flex-col items-center justify-center mt-12 md:mt-24 backdrop-blur-sm bg-black/10 p-8 rounded-3xl border border-white/5 shadow-2xl">
